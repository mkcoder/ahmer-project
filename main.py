...
if __name__ == "__main__":
    ...
    website_configs = [
        ...
        #     "collection_link_class": "dropdown-content visible",
        ...
        # ,
        {
            "base_url": "https://vanya.pk",
            "collection_link_class": "t4s-lh-1 t4s-d-flex t4s-align-items-center t4s-pr",
            "product_link_class": "t4s-full-width-link", # product not scraping
            "product_name":"t4s-product__info-container t4s-product__info-container--sticky",
            "price_class": "money",
            "size_class": "t4s-swatch__list",
            "availability_class": "t4s-btn-atc_text",
        ...
        # ,
        # {
        #     "base_url": "https://mkwears.com",
        #     "collection_link_class": "sf-sub-menu__link",
        #     "product_link_class": "block w-full",
        #     "product_name":"prod__title flex justify-between items-start pr-2 pt-0.5",
        #     "price_class": "text-xl md:text-2xl prod__price text-color-regular-price",
        #     "size_class": "inline-flex flex-wrap",
        #     "availability_class": "not-change atc-text",
        #     "description_class": "product__description prose",
        #     "image_class": "sf-image" #image tag problem
        # }
        # ,
        # {
        #     "base_url": "https://krosskulture.com",
        #     "collection_link_class": "t4s-lh-1 t4s-d-flex t4s-align-items-center t4s-pr",
        #     "product_link_class": "t4s-full-width-link",
        #     "product_name":"t4s-product__info-container t4s-product__info-container--sticky",
        #     "price_class": "money bacurr-money",
        #     "size_class": "t4s-swatch__list",
        #     "availability_class": "t4s-btn-atc_text",
        #     "description_class": "t4s-tab-wrapper t4s-active",
        #     "image_class": "t4s_ratio t4s-product__media is-pswp-disable"
        # }
            ]
