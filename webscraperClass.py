...
class WebScraper:
    ...
    def scrape_product_details(self, product_url, website_config):
        ...
        # this will check the name of a product
        try:
        ...
        # this will check the price of a product    
        try:
        ...
        # this will check the availability of a product
        try:
            availability = soup.find(class_=availability_class).text.strip()
        except AttributeError:
            availability = None
        
        # this will check the description of a product
        try:
            description = soup.find(class_=description_class).text.strip()
        except AttributeError:
            description = None
        
        # this will check the image of a product
        try:
    ...
    def scrape_website(self, config):
        ...
        #Save all product details to the database
